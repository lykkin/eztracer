...
module.exports = function instrumentTimers(_, tracer) {
  // TODO: setInterval
  ...
  instrumentedGlobalTimers.forEach(function instrumentTimer(methodName) {
    ...
    global[methodName] = function wrappedMethod(...args) {
      ...
      return tracer.applySegment(timerSegment, function timeTimerMethod() {
        return oldTimer.apply(global, args)
      })
    }
  })
}
